...
public final class ModeloXYViejo extends Modelo {

	private IloNumVar[][][] x;
	private IloNumVar[] y;
	

	public ModeloXYViejo(Matriz matrix, int k) throws Exception {
		super(matrix, k, 0.01, null);
	}
	
	public ModeloXYViejo(Matriz matrix, int k, OutputStream out) throws Exception {
